...
t = (s["timestamp"] - s["timestamp"].iloc[0]).dt.total_seconds().to_numpy()  # (Normieren auf Startzeit) iloc[0] bezeichnet ersten Wert der Spalte / .dt.total_seconds() wandelt eine Timedelta-Spalte in „Sekunden seit Start“ als Zahlenformat um
